-- 小红书作品更新提醒系统 - 数据库初始化SQL
-- 请在 phpMyAdmin 或 MySQL 命令行中执行此文件

-- 创建数据库（如果不存在）
CREATE DATABASE IF NOT EXISTS xhs_monitor CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE xhs_monitor;

-- 删除旧表（可选，如果需要重新初始化）
-- DROP TABLE IF EXISTS users, notes, monitor_logs, email_logs, settings;
